     ...
     if ($("#slider2").length > 0) {
        ...
        $(document).ready(function() {
            e = jQuery("#slider2").revolution({
                    ...
                    responsiveLevels: [1200, 1024, 768, 576, 480],
                    gridwidth:[1170, 730, 550, 450, 290],
                    gridheight: [1000, 768, 600, 620],
                });
            });
        }
}
...
function lightboxgallery() {}! function(e) {
    ...
    function(e) {
        mainBanner(),mainBanner2(),mainBanner3(), menuFull(), lightboxgallery();
